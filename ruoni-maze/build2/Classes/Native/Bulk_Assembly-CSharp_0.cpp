...
extern "C" IL2CPP_METHOD_ATTR void ballscript__ctor_m212640370 (ballscript_t1740216142 * __this, const RuntimeMethod* method)
{
	{
		MonoBehaviour__ctor_m1579109191(__this, /*hidden argument*/NULL);
		return;
...
extern "C" IL2CPP_METHOD_ATTR void ballscript_Start_m846429762 (ballscript_t1740216142 * __this, const RuntimeMethod* method)
{
	{
		return;
	}
...
extern "C" IL2CPP_METHOD_ATTR void ballscript_Update_m2746325094 (ballscript_t1740216142 * __this, const RuntimeMethod* method)
{
	...
	memset(&V_1, 0, sizeof(V_1));
	{
		...
		GameObject_t1113636619 * L_3 = __this->get_plane_4();
		NullCheck(L_3);
		...
		if ((!(((float)L_2) < ((float)((float)il2cpp_codegen_subtract((float)L_6, (float)(10.0f)))))))
		{
			goto IL_0051;
		}
	}
	{
		...
		GameObject_t1113636619 * L_8 = __this->get_spawnPoint_5();
		NullCheck(L_8);
